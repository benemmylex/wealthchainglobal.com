        ...
        <div class="card shadow-4-strong border border-1 border-primary my-3">
            <div class="card-body">
                ...
                <div class="text-center">
                    <button id="orderCardBtn" class="btn btn-success btn-flat btn-lg mt-4"><i class="fa fa-download"></i> Order Card</button>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <img src="../../assets/images/wallets/<?php echo $crypto['barcode']; ?>" width="150" height="150" class="center-block d-block mx-auto mb-3" alt="QR Code">
                                    <div class="alert alert-light text-center mt-3">
                                        <p class="text-bold mb-1">Wallet Address</p>
                                        <span id="address-<?php echo $crypto['id']; ?>"> <?php echo $crypto['wallet_addr']; ?> </span>
                                    </div>
                                    <button class="btn btn-primary btn-lg btn-block mt-2" onclick="copyToClipboard('<?php echo $crypto['wallet_addr']; ?>')"><i class='fa fa-copy'></i> Click To Copy Address</button>
                                </div>
                            </div>
                        </div>
                    <?php endwhile; ?>
                ...
                <div id="paymentFormSection">
                    <form id="fundCardForm" method="post" enctype="multipart/form-data" action="fund_card">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="trans_id" placeholder="Enter transaction ID" autocomplete="off" required>
                        </div>
                        <div class="form-group">
                            <label>Amount (USD)</label>
                            <input class="form-control" name="amount" placeholder="Enter the amount in USD" autocomplete="off" required>
                        </div>
                        <div class="form-group">
