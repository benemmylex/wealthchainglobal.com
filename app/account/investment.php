        ...
        <div class="card border-1 border border-primary">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    $plans = [];
                    try {
                        $stmt = $db_conn->prepare("SELECT * FROM plans WHERE status = 1 ORDER BY id ASC");
                        $stmt->execute();
                            ...
                            <div class="card border border-1 border-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="my-3" align="center">
                                        <button type="button" onclick="selectPlan($('#amount_<?= $plan['id']; ?>').val(), '<?= strtolower($plan['name']); ?>');" class="btn btn-md btn-primary">Select</button>
                                    </div>
                                </div>
                            </div>
                        </div>
